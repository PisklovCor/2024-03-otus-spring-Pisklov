...
@DataJpaTest
@Import({BookMapper.class, AuthorMapper.class, GenreMapper.class, BookServiceImpl.class, ProxyAclBookServiceImpl.class})
...
class BookServiceImplTest {
    ...
    @MockBean
    private PostProcessInstallingPermission processInstallingPermission;
    ...
    void insert() {
        ...
        verify(processInstallingPermission).settingRights(any());
    }
