...
--changeset pisklov:2024-10-16-002-genres
insert into genres(name)
values ('Fiction'), ('Mystery'), ('Thriller'),
       ('Science fiction'), ('Fantasy'), ('Romance');

--changeset pisklov:2024-10-16-003-books
insert into books(title, author_id)
values ('Im Westen nichts Neues', 1), ('The idiot', 2), ('For Whom the Bell Tolls', 3);

--changeset pisklov:2024-10-16-004-books_genres
insert into books_genres(book_id, genre_id)
values (1, 1),   (1, 2),
       (2, 3),   (2, 4),
       (3, 5),   (3, 6);

--changeset pisklov:2024-10-16-004-comments
...
--changeset pisklov:2024-10-16-006-users
...
--changeset pisklov:2024-10-16-007-role
insert into roles(name, description)
values ('ADMIN', 'Administrator role'),
       ('USER', 'User role');

--changeset pisklov:2024-10-16-008-user_role
